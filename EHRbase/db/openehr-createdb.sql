-- this is basically a copy of https://github.com/nearform/temporal_tables/blob/master/versioning_function.sql
-- check https://github.com/ehrbase/ehrbase/tree/develop/base/db-setup for details
...
SELECT 'CREATE DATABASE ehrbase ENCODING UTF-8 TEMPLATE template0'
    WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'ehrbase')\gexec
